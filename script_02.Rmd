...
gov50 <- filter(en_fall_2020, course_title == "GOV 50")
gov50
```
The class with the highest undergraduate enrollment is Econ 10a: Principles of Economics.

There are two Gov 50 courses listed, since there is a 7am ET and a 12pm ET class. Summed,
these classes have 151 students enrolled.
